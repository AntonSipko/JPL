...
public interface ValidationConstants {
	...
	String MISSING_CAR_COLOR = "Missing car color";
	String MISSING_CAR_YEAR_MESSAGE = "Missing car year";
	String MISSING_NAME = "Missing car name";
	String YEAR_IS_NULL = "Year can't be null";
	String MISSING_COMPANY = "Missing Company Name";
	String ENGINE_CAPACITY_IS_NULL = "Engine Capacity can't be null";
	String MISSING_ENGINE_CAPACITY = "Missing Engine Capacity";
